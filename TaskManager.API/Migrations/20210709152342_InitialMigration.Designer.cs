...
namespace TaskManager.API.Migrations
{
    ...
    [Migration("20210709152342_InitialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskManager.Authentication.UserMaster", b =>
                {
            ...
            modelBuilder.Entity("TaskManager.Authentication.UserType", b =>
                {
                    b.Property<int>("UserTypeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("TaskManager.Models.Skill", b =>
                {
                    b.HasOne("TaskManager.Authentication.UserMaster", "ApplicationUser")
                        .WithMany()
                        .HasForeignKey("Id");
            ...
            modelBuilder.Entity("TaskManager.Models.Task", b =>
                {
                    b.HasOne("TaskManager.Authentication.UserMaster", "AssignedToUser")
                        .WithMany()
                        .HasForeignKey("AssignedTo");

                    b.HasOne("TaskManager.Authentication.UserMaster", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManager.Models.TaskStatusDetail", b =>
                {
                    ...
                    b.HasOne("TaskManager.Authentication.UserMaster", "User")
                        .WithMany()
