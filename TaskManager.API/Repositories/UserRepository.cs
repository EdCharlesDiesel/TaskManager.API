...
namespace TaskManager.API.Repositories
{
    public class UserRepository : IUserService
    {
        ...
        //UserMaster IUserService.Authenticate(string username, string password)
        //{
        //    throw new NotImplementedException();
        //}

        IEnumerable<UserMaster> IUserService.GetAll()
        {
            throw new NotImplementedException();
        }

        //UserMaster IUserService.GetById(int userId)
        //{
        //    throw new NotImplementedException();
        //}
